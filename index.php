...
if($row>0)
{
	echo "<script>alert('Email id already exist. Please try other email id');</script>";
} else{
	 ...
	 <div class="sap_tabs">	
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
			  <ul class="resp-tabs-list">
			  	  <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><div class="top-img"><img src="images/top-note.png" alt=""/></div><span>Signup</span>
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" onSubmit="return validate();" method="post" enctype="multipart/form-data">
								<p>First Name </p>
